...
![UI/UX](https://img.shields.io/badge/UI-Modern%20Dashboard-black?style=for-the-badge)
...
```mermaid
flowchart LR
A[Foundation Level] --> B[Intermediate Level]
B --> C[Advanced Level]
C --> D[Management Level]

A --> A1(Fire Safety)
A --> A2(PPE & Hazard Basics)

B --> B1(Construction Safety)
B --> B2(Occupational Safety)

C --> C1(Industrial Safety Management)

D --> D1(Process Safety Management)
```
